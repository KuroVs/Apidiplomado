...
class ModelInput(PydanticBaseModel):
    ...
    IdServicio: int = Field(description='Tipo de servicio del vehículo', ge=1, le=2)
...
class APIModelBackEnd():
    ...
    def __init__(self,IdServicio,Bcpp,Potencia,Cilindraje,PesoCategoria,Marca,Clase,Fechas):
        '''
    ...
    def _prepare_data(self):
        ...
        f2 = ['IdServicio', 'Bcpp', 'Potencia', 'Cilindraje', 'PesoCategoria', 'Marca_ACURA', 
        ...
        df2['IdServicio'] = self.IdServicio
        df2['Bcpp'] = self.Bcpp
